  ...
  <div class="funds-list">
    ...
    <div class="table_container">
      <el-table :data="tableData" style="width: 100%" max-height="450" stripe>
        ...
        <el-table-column label="维修内容" width="100" prop="expenditure">
          <template #default="scope">
            <span>{{ scope.row.expenditure }}</span>
          </template>
        </el-table-column>
        <el-table-column label="维修描述" width="130" prop="description">
        </el-table-column>
        <el-table-column label="维修状况" width="150" prop="account">
          <template #default="scope">
...
import DialogVue from "@/components/Dialog1.vue";
...
const handleDelete = (index, row) => {
  proxy.$axios.post(`/funds1/delete1/${row.id}`).then((res) => {
    proxy.$message("删除成功！");
    getProfile();
  });
};
