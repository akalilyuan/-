  ...
  <div class="funds-list">
    ...
    <div class="table_container">
      <el-table :data="tableData" style="width: 100%" max-height="450" stripe>
        ...
        <el-table-column label="物业费" width="150" prop="account">
          <template #default="scope">
            <span>{{ scope.row.account }}</span>
          </template>
        </el-table-column>
        <el-table-column label="缴费说明" width="130" prop="description">
        </el-table-column>
        <el-table-column label="缴费时间" width="100" prop="expenditure">
          <template #default="scope">
...
import DialogVue from "@/components/Dialog3.vue";
...
const handleDelete = (index, row) => {
  proxy.$axios.post(`/funds3/delete3/${row.id}`).then((res) => {
    proxy.$message("删除成功！");
    getProfile();
  });
};
